...
bool Renderer::LoadGeometry(char* meshFile, Model* model)
{
	//Load Vertex buffer
...
bool Renderer::LoadObject(GameObject* Object)
{
...
bool Renderer::LoadCamera(Camera* cam)
{
...
bool Renderer::CreateViewsDependWindowSize()
{
	m_deferredLighting->textureWidth = windowWidth;
	m_deferredLighting->textureHeight = windowHeight;
...
void Renderer::SetBuffersNewSize()
{
...
void Renderer::SetNormalState()
{
	m_device->d3dContext_->RSSetState(m_RSNormal);
}

void Renderer::SetWireFrameState()
{
